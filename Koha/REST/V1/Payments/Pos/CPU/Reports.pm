...
sub cpu_pos_report {
    ...
    my $logger = Koha::Logger->get({ category=> 'Koha.REST.V1.Payments.Pos.CPU.Reports.cpu_pos_report' });
    ...
    my $interface = Koha::Payment::POS->new({ branch => $transaction->user_branch });

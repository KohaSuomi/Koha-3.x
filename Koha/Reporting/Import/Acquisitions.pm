...
sub loadDatas{
    ...
    $query .= 'allitems.itype as itemtype, allbitems.marcxml, allbitems.publicationyear as published_year ';
    $query .= 'from aqorders ';
    $query .= 'inner join aqorders_items on aqorders.ordernumber = aqorders_items.ordernumber ';
    $query .= 'inner join items ';
    $query .= 'as allitems on aqorders_items.itemnumber=allitems.itemnumber and allitems.itype not in ("SL", "LA") and allitems.notforloan != -1 ';
    ...
    $query2 .= 'allitems.itype as itemtype, allbitems.marcxml, allbitems.publicationyear as published_year ';
    ...
    $query2 .= 'as allitems on aqorders_items.itemnumber=allitems.itemnumber and allitems.itype not in ("SL", "LA") and allitems.notforloan != -1 ';
    ...
    $query3 .= 'allitems.itype as itemtype, allbitems.marcxml, allbitems.publicationyear as published_year ';
    ...
    $query3 .= 'as allitems on aqorders_items.itemnumber=allitems.itemnumber and allitems.itype not in ("SL", "LA") and allitems.notforloan != -1 ';
    ...
    $query4 .= 'allitems.itype as itemtype, allbitems.marcxml, allbitems.publicationyear as published_year ';
    ...
    $query4 .= 'as allitems on aqorders_items.itemnumber=allitems.itemnumber and allitems.itype not in ("SL", "LA") and allitems.notforloan != -1 ';

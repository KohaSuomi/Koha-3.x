...
sub loadDatas{
    ...
    $query .= "from deletedborrowers where deletedborrowers.dateenrolled IS NOT NULL and deletedborrowers.categorycode in ('HENKILO', 'MUUHUOL', 'KOTIPALVEL', 'LAPSI', 'YHTEISO') ";

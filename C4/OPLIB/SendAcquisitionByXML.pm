...
sub sendBasketGroupAsXml{
    ...
    my $branchdetail = GetBranchDetail($basketgroup->{billingplace});
    my $branchemail = $branchdetail->{branchemail};
    ...
    $msg->send;
    C4::OPLIB::AcquisitionIntegration::markBasketgroupAsOrdered($basketgroup);
    return 0;
}

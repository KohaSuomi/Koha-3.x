...
package C4::OPLIB::RemoteBiblioPackageImporter;
...
=head2 new
    ...
    my $importer = C4::OPLIB::RemoteBiblioPackageImporter->new({
...
sub setRemote {
    my ($self, $remoteId) = @_;
    $self->{remote} = C4::OPLIB::AcquisitionIntegration::getVendorConfig($remoteId);
}
sub getRemote {
    return shift->{remote};
}
...
=head stageLocalPackages
    ...
    C4::OPLIB::RemoteBiblioPackageImporter->stageLocalPackages($localPackages, $encoding, $matcher, $format);

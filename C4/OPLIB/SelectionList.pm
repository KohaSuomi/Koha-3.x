package C4::OPLIB::SelectionList;
...
=head new
    ...
    my $sl = C4::OPLIB::SelectionList->new({
    ...
    my $sl = C4::OPLIB::SelectionList->new($marcRecord); #Create the SelectionList out of a MARC::Record object.
    my $sl = C4::OPLIB::SelectionList->new($marcRecord, $selectionListBatch); #
...
STATIC FUNCTION
    my $identifier = C4::OPLIB::SelectionList::GetSelectionListIdentifier($marcRecord);
=cut

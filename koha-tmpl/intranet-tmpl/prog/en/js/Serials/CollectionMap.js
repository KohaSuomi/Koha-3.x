...
Serials.CollectionMap = {
    ...
    _bindEvents: function (self) {
        ...
        .on('activate_node.jstree', function (what, data){
            ...
            var patterns_xyz = node_id.split(":");
            Serials.CollectionMap.displaySerialItems(self, {pattern_x: patterns_xyz[0],
                                                            pattern_y: patterns_xyz[1],
                                                            pattern_z: patterns_xyz[2],
                                                            biblionumber: self.biblionumber,
                                                        }
                                                    );
        });
     ...
     *        @key 'pattern_x', the first serial issue enumeration field, typically the year.
     *        @key 'pattern_y', the second enumeration, eg volume.
     *        @key 'pattern_z', the third enumeration.
        ...
        $.ajax("/api/v1/serialitems",
            {   "method": "get",
                ...
                "data": {
                    ...
                    pattern_x: params.pattern_x,
                    pattern_y: params.pattern_y,
                    pattern_z: params.pattern_z,

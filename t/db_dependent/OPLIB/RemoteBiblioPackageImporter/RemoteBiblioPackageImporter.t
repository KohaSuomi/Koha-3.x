...
use t::db_dependent::OPLIB::RemoteBiblioPackageImporter::Context;
...
my $testContext = {};
my $matchers = t::db_dependent::OPLIB::RemoteBiblioPackageImporter::Context->prepareContext($testContext);
...
sub connectAndVerify {
    ...
    $importer = C4::OPLIB::RemoteBiblioPackageImporter->new({remoteId => 'BTJBiblios'});
    ...
    my $B20160419xma = File::Fu::File->new($ENV{KOHA_PATH}.'/t/db_dependent/OPLIB/RemoteBiblioPackageImporter/B20160419xma');
    my $B20160419xmk = File::Fu::File->new($ENV{KOHA_PATH}.'/t/db_dependent/OPLIB/RemoteBiblioPackageImporter/B20160419xmk');
    my $B20160420xmk = File::Fu::File->new($ENV{KOHA_PATH}.'/t/db_dependent/OPLIB/RemoteBiblioPackageImporter/B20160420xmk');

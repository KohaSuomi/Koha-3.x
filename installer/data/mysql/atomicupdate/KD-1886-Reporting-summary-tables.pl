...
my $atomicUpdater=Koha::AtomicUpdated->new();

unless ($atomicUpdater->find('KD-1886-reporting-summary-tables')) {

$dbh->do ( "DROP TABLE IF EXISTS `reporting_import_settings`;" );
...
$dhb->do ( "DROP TABLE IF EXISTS `reporting_item_dim`;" );
...
$dbh->do ( "DROP TABLE IF EXISTS `reporting_date_dim`;" );
...
$dbh->do ( "DROP TABLE IF EXISTS `reporting_borrower_dim`;" );
...
$dbh->do ( "DROP TABLE IF EXISTS `reporting_location_dim`;" );
...
$dbh->do ( "DROP TABLE IF EXISTS `reporting_loans_fact`;" );
...
$dbh->do ( "DROP TABLE IF EXISTS `reporting_fines_overdue_fact`;" );
...
$dbh->do ( "DROP TABLE IF EXISTS `reporting_borrowers_fact`;" );
...
$dbh->do ( "DROP TABLE IF EXISTS `reporting_acquisitions_fact`;" );
...
$dbh->do ( "DROP TABLE IF EXISTS `reporting_items_fact`;" );
...
$dbh->do ( "DROP TABLE IF EXISTS `reporting_deleteditems_fact`;" );
...
$dbh->do ( "DROP TABLE IF EXISTS `reporting_update_items`;" );
...
$dbh->do ( "DROP TABLE IF EXISTS `reporting_returns_fact`;" );
...
$dbh->do ( "DROP TABLE IF EXISTS `reporting_reserves_fact`;" );
...
$dbh->do ( "DROP TABLE IF EXISTS `reporting_fines_paid_fact`;" );
...
$dbh->do ( "DROP TABLE IF EXISTS `reporting_messages_fact`;" );
...
$dbh->do ( "DROP TABLE IF EXISTS `reporting_acquisitions_isfirst`;" );
...
print "Upgrade done (KD-1886-reporting-summary-tables).\n";
